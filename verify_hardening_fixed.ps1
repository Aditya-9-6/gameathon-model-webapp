...
# verify_hardening_fixed.ps1
$backendPath = "C:\ironwall-gamethon-target\debug\ironwall-gamethon.exe"
$stdoutFile = "C:\Users\om laptop house\.gemini\antigravity\brain\fccf4027-539f-41c0-9fab-dce7356dc6b8\backend_stdout.log"
$stderrFile = "C:\Users\om laptop house\.gemini\antigravity\brain\fccf4027-539f-41c0-9fab-dce7356dc6b8\backend_stderr.log"

Remove-Item $stdoutFile -ErrorAction SilentlyContinue
Remove-Item $stderrFile -ErrorAction SilentlyContinue

Write-Host "Starting Backend..."
$process = Start-Process $backendPath -NoNewWindow -PassThru -RedirectStandardOutput $stdoutFile -RedirectStandardError $stderrFile
...
Write-Host "Reading Full Log Content (STDOUT):"
if (Test-Path $stdoutFile) {
    Get-Content $stdoutFile | foreach { Write-Host $_ }
}
Write-Host "Reading Full Log Content (STDERR):"
if (Test-Path $stderrFile) {
    Get-Content $stderrFile | foreach { Write-Host $_ }
}
